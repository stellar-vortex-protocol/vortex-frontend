...
const STAGES: { labelKey: MessageKey; subKey: MessageKey; color: string }[] = [
  {
    labelKey: "home.pipeline.intent.label",
    subKey: "home.pipeline.intent.sub",
    color: "#A78BFA",
  },
  {
    labelKey: "home.pipeline.auction.label",
    subKey: "home.pipeline.auction.sub",
    color: "#60A5FA",
  },
  {
    labelKey: "home.pipeline.relay.label",
    subKey: "home.pipeline.relay.sub",
    color: "#4CEBA8",
  },
  {
    labelKey: "home.pipeline.settle.label",
    subKey: "home.pipeline.settle.sub",
    color: "#4CEBA8",
  },
];
        ...
        <div key={s.labelKey} className="flex items-center">
          <div className="flex flex-col items-center gap-1.5">
            ...
            <div className="text-center">
              <div className="text-[11px] font-semibold text-vx-text">
                {t(s.labelKey)}
              </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              {stats.map((s) => (
                <div key={s.labelKey} className="card-sm px-4 py-3">
                  <div className="num text-xl font-semibold text-vx-text">
                    {s.value}
                  </div>
            ...
            <div className="mt-5">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-vx-sage-bg rounded-lg border border-vx-sage/20">
                  <span
                    aria-hidden="true"
                    className="w-2 h-2 rounded-full bg-vx-sage"
                  />
